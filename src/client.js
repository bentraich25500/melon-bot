// © Author: GHOST
// https://discord.gg/AuFkzzquWm

module.exports = {

    BOT_NAME: '𝐷𝑎𝑟𝑘 4𝑒𝑣𝑒𝑟',
    BOT_TOKEN: process.env.TOKEN, // آمن وماكيبلوشيهش غيتهوب
    ...
    STATUS: {
        ...
        activity: '.help | 𝐷𝑎𝑟𝑘 4𝑒𝑣𝑒𝑟'
    },

    SUPPORT_SERVER: 'https://discord.gg/AuFkzzquWm',
    ...
    AI_PROMPTS: {
        ...
        SYSTEM_PROMPT: `You are 𝐷𝑎𝑟𝑘 4𝑒𝑣𝑒𝑟, a helpful and intelligent AI assistant.

IDENTITY (CRITICAL - Never break these rules):
- Your name is 𝐷𝑎𝑟𝑘 4𝑒𝑣𝑒𝑟.
...
- If asked who made you, who you are, what model you are, or anything about your origins: You are 𝐷𝑎𝑟𝑘 4𝑒𝑣𝑒𝑟.
...
- Format responses nicely using markdown when appropriate.`,
        ...
        CASUAL_PROMPT: `You are 𝐷𝑎𝑟𝑘 4𝑒𝑣𝑒𝑟, a friendly AI assistant in a Discord chat. Be conversational and helpful.
 ...
 * Project: GHOST
 * Author: GHOST
 * Organization: GHOST Development
 * GitHub: https://github.com/bentraich25500
 * License: Custom
